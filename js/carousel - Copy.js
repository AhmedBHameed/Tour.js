...
fn.render = function(){
	...
	if (this.slideToRight){
		prevItem.classList.add('prevright');
		currItem.classList.add('nextright');
		window.setTimeout(function(){
			prevItem.classList.remove('active');
			currItem.classList.add('active');
		}.bind(this), 20);
		window.setTimeout(function(){
			prevItem.classList.remove('prevright');
			currItem.classList.remove('nextright');
			this.underAnimate = true;
		}.bind(this), 600)
	}else{
		prevItem.classList.add('prevleft');
		currItem.classList.add('nextleft')
		window.setTimeout(function(){
			prevItem.classList.remove('active');
			currItem.classList.add('active');
		}.bind(this), 20);
		window.setTimeout(function(){
			prevItem.classList.remove('prevleft');
			currItem.classList.remove('nextleft');
			this.underAnimate = true;
		}.bind(this), 600);		
	}
	return;
